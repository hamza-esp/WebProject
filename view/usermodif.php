...
?>
        <section class="htc__category__area ptb--100">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <div class="section__title--2 text-center">
                            <h2 class="title__line">mes donneés</h2>
            ...
            <form action="../controller/userC/modification.php" method="post">
                <h2 class="text-center">mes donneés</h2>       
                <div class="form-group">
                    <input type="text" name="pseudo" value="<?php echo $data['pseudo']; ?>" class="form-control"   onclick="nameValidation" >
