...
<div class="row" id="articleList">
   ...
   include_once '../controller/articleC/ArticleC.php';
                  ...
                  $listeTD=$ArticleC->mesArticles($_SESSION['user']);
                            ...
                            <div class="blog">
                                <div class="blog__details">
                                    ...
                                    <div class="blog__btn">
                                      ...
                                      <a href="modifier-article.php?id=<?php echo  $value['id'] ?>"><button style="width:120px;" type="button" class="btn btn-primary">Modifier</button></a>
                                      <a href="../controller/articleC/article-delete.php?id=<?php echo  $value['id'] ?>"><button  style="width:120px;" type="button" class="btn btn-danger">Supprimer</button></a>
