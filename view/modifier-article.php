   ...
   include_once '../controller/articleC/ArticleC.php';
                  ...
                  if ($_SERVER["REQUEST_METHOD"] == "POST") {
                    ...
                    if (!empty($errors)) {
                        ...
                        $ArticleC->updateArticle($_GET['id'],$title,$subject);
                    ...
                    <div class="contact-form-wrap mt--60">
                        <div class="col-xs-12">
                            <div class="contact-title">
                                <h2 class="title__line--6">Modifier Article</h2>
                            </div>
                        </div>
                        ...
                        <div class="col-xs-12">
                                <div class="single-contact-form">
                                    <div class="contact-box subject">
                                        <input value="<?= $row[0]['title']; ?>" type="text" name="title" placeholder="titre">
                                    </div>
                                </div>
                                <div class="single-contact-form">
                                    <div class="contact-box message">
                                        <textarea name="subject" placeholder="sujet"><?= $row[0]['subject']; ?></textarea>
                                    </div>
                                </div>
