<?php
   ...
   $listeTD=$ArticleC->listArticles("admin");
?>
<!DOCTYPE html>
<html lang="en">
  ...
  <label class="form-check-label" for="treated-checkbox">
    Treated only
         ...
         if($value['status'] == "pending")   {
           echo   '<a href="../../controller/articleC/article-treated.php?id='  .$value['id'].'"><button  type="submit" class="btn btn-primary btn-xs"><i class="fa fa-check "></i></button></a>';
         }            
         ?>                        
        <a href="../../controller/articleC/article-delete.php?delete=<?php echo    $value['id']; ?>"><button  type="submit" class="btn btn-danger btn-xs"><i class="fa fa-trash "></i></button></a>
